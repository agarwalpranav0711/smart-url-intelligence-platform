 ...
 * Deletes analytics rows older than 90 days and idempotency rows older than 24 hours in bounded batches of 5000.
 */
async function runMaintenanceCleanup() {
  ...
  try {
    ...
    return { totalAnalyticsDeleted, totalIdempotencyDeleted };
  } catch (err) {
